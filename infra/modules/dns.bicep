...
@sys.description('Allows managed identity to manage DNS TXT records.')
resource dnsTxtContributorRoleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(dnsZone.id, dnsTxtContributorRole.id, principalId)
  scope: dnsZone
  properties: {
